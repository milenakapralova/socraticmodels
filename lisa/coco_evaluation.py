...
# Local imports
from image_captioning import ClipManager, ImageManager
from utils import get_device, prepare_dir, get_uuid_for_imgs
...
def load_caption_baseline():
    ...
    try:
        ...
        raise FileNotFoundError(
            "baseline_caption.csv not found! Please run the coco_captioning_baseline.py or coco_captioning_improved_old.py "
...
def load_caption_improved():
    ...
    try:
        ...
        raise FileNotFoundError(
            "improved_caption.csv not found! Please run the coco_captioning_baseline.py or coco_captioning_improved_old.py "
            "to obtain the generated captions before proceeding with the evaluation."
        )
    return res_improved
