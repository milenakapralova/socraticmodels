...
<div style="display: flex; flex-direction: row;">
    <div style="flex: 50%; text-align: center;">
        <figure>
            <img src="blogpost_images/demo_img.png" alt="Image 1" width="500" height="300">
    ...
    <div style="flex: 50%; text-align: center;">
        <figure>
            <img src="blogpost_images/astronaut_with_beer.jpg" alt="Image 2"  width="500" height="300">
...
<div style="display: flex; flex-direction: row;">
    <div style="flex: 50%; text-align: center;">
        <figure>
            <img src="blogpost_images/monkey_with_gun.jpg" alt="Image 1" width="500" height="300">
    ...
    <div style="flex: 50%; text-align: center;">
        <figure>
            <img src="blogpost_images/fruit_bowl.jpg" alt="Image 2" width="500" height="300">
